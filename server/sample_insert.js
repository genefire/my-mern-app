...
const uri = "mongodb+srv://stampfire:slXAsTtOOx5wvm3k@cluster0.mwwnghw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
 ...
 async function run() {
    try {
        // Connect to the Atlas cluster
         ...
         const db = client.db("wjs");
         const col = db.collection("participant");
